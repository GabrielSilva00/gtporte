...
export function ToastContainer(){
  ...
  return <div className="fixed inset-x-4 top-[env(safe-area-inset-top,12px)] z-[100] flex flex-col gap-2 pt-2">
    {q.map(x=><div key={x.id} className={`flex items-center gap-3 rounded-2xl px-4 py-3 text-sm font-medium shadow-xl anim-in ${x.t==='ok'?'bg-emerald-500/90':'bg-rose-500/90'} text-[#fff]`}>
