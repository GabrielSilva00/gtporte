...
from (values
  ('UNESP Aracatuba',      'Aracatuba',     '#1F3A2E'),
  ('UNESP Ilha Solteira',  'Ilha Solteira', '#1F3A2E'),
  ('UFSCar Sao Carlos',    'Sao Carlos',    '#8A5A15'),
  ('FATEC Aracatuba',      'Aracatuba',     '#C4633A'),
  ('Unicamp Limeira',      'Limeira',       '#2E7D5A'),
  ('UNIP Aracatuba',       'Aracatuba',     '#9E3E3E')
...
from (values
  ('R01', 'Aracatuba -> UFSCar Sao Carlos',    'Aracatuba',  'Sao Carlos',    'UFSCar Sao Carlos',   'OPE-1234', '02887411231', '05:40', '22:30', 'ativa',  'Saida do terminal rodoviario'),
  ('R02', 'Aracatuba -> UNESP Ilha Solteira',  'Aracatuba',  'Ilha Solteira', 'UNESP Ilha Solteira', 'OXY-9876', '03442015876', '06:00', '22:45', 'ativa',  'Paradas em Bilac e Birigui'),
  ('R03', 'Guararapes <-> UNESP Aracatuba',    'Guararapes', 'Aracatuba',     'UNESP Aracatuba',     'OSC-4410', '04127788901', '17:30', '23:15', 'ativa',  'Turno noturno'),
  ...
  ('R05', 'Penapolis -> FATEC Aracatuba',      'Penapolis',  'Aracatuba',     'FATEC Aracatuba',     'OWL-3345', '01998812234', '05:20', '22:15', 'ativa',  'Alta demanda'),
  ('R06', 'Coroados -> UNESP Aracatuba',       'Coroados',   'Aracatuba',     'UNESP Aracatuba',     'QAT-8876', '03556677021', '06:30', '22:30', 'revisao','Em revisao de itinerario')
...
-- Estudantes (RF01)
-- ---------------------------------------------------------------------
insert into public.estudante (nome, ra, cpf, data_nascimento, telefone, email, curso,
                              endereco, universidade_id, cidade_id, perfil_uso, status_documental)
select v.nome, v.ra, v.cpf, v.nasc::date, v.fone, v.email, v.curso, v.endereco,
       u.id, c.id, v.uso::perfil_uso, v.doc::status_documental
from (values
  ('Marina Cavalcanti Rocha',   '20241834', '412.887.330-01', '2004-03-12', '(18) 99841-2210', 'marina.rocha@email.com',   'Direito',        'Rua Floriano Peixoto, 220',  'UNESP Aracatuba',     'Guararapes',  'ida_volta',    'aprovado'),
  ('Igor Bastos Nakamura',      '20240087', '388.112.440-72', '2003-07-25', '(18) 99712-8890', 'igor.nakamura@email.com',  'ADS',            'Av. Brasilia, 1450',         'FATEC Aracatuba',     'Penapolis',   'ida_volta',    'aprovado'),
  ('Beatriz Pinheiro Santos',   '20238812', '501.774.220-38', '2002-11-04', '(18) 99655-1120', 'beatriz.santos@email.com', 'Direito',        'Rua Sao Paulo, 87',          'UFSCar Sao Carlos',   'Aracatuba',   'ida_volta',    'pendente'),
  ('Rafael Toledo Ferraz',      '20241102', '445.220.118-90', '2004-01-19', '(18) 99530-4471', 'rafael.ferraz@email.com',  'Eng. Eletrica',  'Rua Ceara, 330',             'UNESP Ilha Solteira', 'Aracatuba',   'ida_volta',    'aprovado'),
  ...
  ('Diego Ferrari Montenegro',  '20250334', '477.881.220-13', '2005-02-08', '(18) 99114-7723', 'diego.montenegro@email.com','Enfermagem',    'Av. Governador, 90',         'UNESP Aracatuba',     'Coroados',    'ida_volta',    'rejeitado'),
  ('Ana Luisa Barreto Xavier',  '20239914', '366.442.980-27', '2003-05-15', '(18) 99442-6650', 'ana.xavier@email.com',     'Eng. Civil',     'Rua Piaui, 78',              'UFSCar Sao Carlos',   'Aracatuba',   'ida_volta',    'aprovado'),
  ('Vinicius Camargo Peixoto',  '20240552', '412.009.887-64', '2004-08-22', '(18) 99377-2214', 'vinicius.peixoto@email.com','GTI',           'Rua Parana, 1200',           'FATEC Aracatuba',     'Penapolis',   'ida_volta',    'aprovado'),
  ('Otavio Cerqueira Lins',     '20240113', '520.117.664-30', '2002-12-01', '(18) 99880-1145', 'otavio.lins@email.com',    'Medicina',       'Rua Sergipe, 15',            'UFSCar Sao Carlos',   'Aracatuba',   'ida_volta',    'aprovado'),
  ('Priscila Naves Costa',      '20240995', '399.556.221-08', '2003-04-17', '(18) 99664-0092', 'priscila.costa@email.com', 'Quimica',        'Av. Joubert, 640',           'UFSCar Sao Carlos',   'Aracatuba',   'ida_volta',    'aprovado'),
  ('Mateus Braga Cortez',       '20241377', '433.778.115-59', '2004-06-09', '(18) 99201-7734', 'mateus.cortez@email.com',  'Eng. Mecanica',  'Rua Goias, 410',             'UNESP Ilha Solteira', 'Aracatuba',   'ida_volta',    'aprovado'),
  ('Fernanda Salles Vidal',     '20241448', '408.229.775-16', '2003-10-27', '(18) 99558-2201', 'fernanda.vidal@email.com', 'Fisica',         'Rua Minas Gerais, 233',      'UNESP Ilha Solteira', 'Aracatuba',   'ida_volta',    'aprovado'),
  ('Kaue Melo Antunes',         '20241560', '451.660.339-84', '2004-02-14', '(18) 99310-6688', 'kaue.antunes@email.com',   'Eng. Civil',     'Rua Amazonas, 900',          'UNESP Ilha Solteira', 'Aracatuba',   'ida_volta',    'aprovado'),
  ('Bruno Wagner Ibanez',       '20240771', '377.114.882-25', '2003-01-30', '(18) 99447-3320', 'bruno.ibanez@email.com',   'ADS',            'Rua Tiradentes, 55',         'FATEC Aracatuba',     'Penapolis',   'ida_volta',    'aprovado'),
  ('Camila Reis Bonfim',        '20241688', '462.335.117-70', '2004-09-11', '(18) 99223-9981', 'camila.bonfim@email.com',  'GTI',            'Rua Rui Barbosa, 320',       'FATEC Aracatuba',     'Penapolis',   'ida_volta',    'pendente'),
  ('Tulio Machado Prado',       '20241902', '489.007.223-41', '2004-05-02', '(18) 99118-4470', 'tulio.prado@email.com',    'Odontologia',    'Rua Duque de Caxias, 44',    'UNESP Aracatuba',     'Guararapes',  'ida_volta',    'aprovado'),
  ('Yasmin Cabral Lima',        '20240712', '355.998.114-06', '2003-08-19', '(18) 99664-5512', 'yasmin.lima@email.com',    'Veterinaria',    'Rua XV de Novembro, 780',    'UNESP Aracatuba',     'Guararapes',  'somente_volta','aprovado'),
  ('Renato Furtado Braga',      '20241456', '421.556.008-93', '2004-11-23', '(18) 99775-1103', 'renato.braga@email.com',   'Odontologia',    'Av. Prestes Maia, 210',      'UNESP Aracatuba',     'Guararapes',  'ida_volta',    'aprovado'),
  ('Camilla Osorio de Freitas', '20241119', '404.771.335-28', '2003-03-07', '(18) 99332-8840', 'camilla.freitas@email.com','Veterinaria',    'Rua Sao Joao, 66',           'UNESP Aracatuba',     'Guararapes',  'ida_volta',    'aprovado'),
  ('Fabio Kuroda Nishimoto',    '20240824', '398.116.774-52', '2003-12-16', '(18) 99880-3324', 'fabio.nishimoto@email.com','Medicina Vet.',  'Rua Marechal Deodoro, 501',  'UNESP Aracatuba',     'Guararapes',  'ida_volta',    'aprovado'),
  ('Lucas Emiliano Bertazzo',   '20250114', '470.223.669-17', '2005-01-08', '(18) 99441-0075', 'lucas.bertazzo@email.com', 'Zootecnia',      'Rua Pernambuco, 145',        'UNESP Aracatuba',     'Guararapes',  'ida_volta',    'aprovado'),
  ...
  ('Larissa Meira Fontes',      '20241844', '419.887.005-34', '2004-10-21', '(18) 99553-2280', 'larissa.fontes@email.com', 'Eng. Eletrica',  'Rua Espirito Santo, 92',     'UNESP Ilha Solteira', 'Aracatuba',   'ida_volta',    'pendente')
) as v(nome, ra, cpf, nasc, fone, email, curso, endereco, universidade, cidade, uso, doc)
join public.universidade u on u.nome = v.universidade
join public.cidade c       on c.nome = v.cidade
