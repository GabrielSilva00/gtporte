...
export function TelaCarregamento({ carregando, texto = 'Carregando…' }: { carregando: boolean; texto?: string }) {
  ...
  return (
    <div
      ...
      className={`fixed inset-0 z-[200] flex flex-col items-center justify-center gap-1 bg-base px-6 transition-opacity motion-reduce:transition-none ${fase === 'saindo' ? 'pointer-events-none opacity-0' : 'opacity-100'}`}
